...
var require_ini = __commonJS({
  "../../node_modules/.pnpm/ini@2.0.0/node_modules/ini/ini.js"(exports, module2) {
    ...
    var encode = /* @__PURE__ */ __name2((obj, opt) => {
      const children = [];
      let out = "";
    ...
    var dotSplit = /* @__PURE__ */ __name2((str) => str.replace(/\1/g, "LITERAL\\1LITERAL").replace(/\\\./g, "").split(/\./).map((part) => part.replace(/\1/g, "\\.").replace(/\2LITERAL\\1LITERAL\2/g, "")), "dotSplit");
    var decode = /* @__PURE__ */ __name2((str) => {
    ...
    var isQuoted = /* @__PURE__ */ __name2((val) => val.charAt(0) === '"' && val.slice(-1) === '"' || val.charAt(0) === "'" && val.slice(-1) === "'", "isQuoted");
    var safe = /* @__PURE__ */ __name2((val) => typeof val !== "string" || val.match(/[=\r\n]/) || val.match(/^\[/) || val.length > 1 && isQuoted(val) || val !== val.trim() ? JSON.stringify(val) : val.replace(/;/g, "\\;").replace(/#/g, "\\#"), "safe");
    var unsafe = /* @__PURE__ */ __name2((val, doUnesc) => {
      val = (val || "").trim();
      if (isQuoted(val)) {
        if (val.charAt(0) === "'")
...
var require_global_dirs = __commonJS({
  "../../node_modules/.pnpm/global-dirs@3.0.0/node_modules/global-dirs/index.js"(exports) {
    ...
    var getYarnWindowsDirectory = /* @__PURE__ */ __name2(() => {
    ...
    var getYarnPrefix = /* @__PURE__ */ __name2(() => {
      if (process.env.PREFIX) {
        return process.env.PREFIX;
      }
...
var require_conversions = __commonJS({
  "../../node_modules/.pnpm/color-convert@2.0.1/node_modules/color-convert/conversions.js"(exports, module2) {
    ...
    convert.rgb.hsv = function(rgb) {
      ...
      const diffc = /* @__PURE__ */ __name2(function(c) {
    ...
    __name2(comparativeDistance, "comparativeDistance");
...
var require_route = __commonJS({
  "../../node_modules/.pnpm/color-convert@2.0.1/node_modules/color-convert/route.js"(exports, module2) {
    ...
    __name2(wrapConversion, "wrapConversion");
...
var require_color_convert = __commonJS({
  "../../node_modules/.pnpm/color-convert@2.0.1/node_modules/color-convert/index.js"(exports, module2) {
    ...
    function wrapRaw(fn) {
      const wrappedFn = /* @__PURE__ */ __name2(function(...args) {
        const arg0 = args[0];
    ...
    __name2(wrapRounded, "wrapRounded");
...
var require_ansi_styles = __commonJS({
  "../../node_modules/.pnpm/ansi-styles@4.3.0/node_modules/ansi-styles/index.js"(exports, module2) {
    "use strict";
    var wrapAnsi16 = /* @__PURE__ */ __name2((fn, offset) => (...args) => {
      const code = fn(...args);
      return `[${code + offset}m`;
    }, "wrapAnsi16");
    var wrapAnsi256 = /* @__PURE__ */ __name2((fn, offset) => (...args) => {
      const code = fn(...args);
      return `[${38 + offset};5;${code}m`;
    }, "wrapAnsi256");
    var wrapAnsi16m = /* @__PURE__ */ __name2((fn, offset) => (...args) => {
      const rgb = fn(...args);
      return `[${38 + offset};2;${rgb[0]};${rgb[1]};${rgb[2]}m`;
    }, "wrapAnsi16m");
    var ansi2ansi = /* @__PURE__ */ __name2((n) => n, "ansi2ansi");
    var rgb2rgb = /* @__PURE__ */ __name2((r, g, b2) => [r, g, b2], "rgb2rgb");
    var setLazyProperty = /* @__PURE__ */ __name2((object, property, get) => {
    ...
    var colorConvert;
    var makeDynamicStyles = /* @__PURE__ */ __name2((wrap, targetSpace, identity, isBackground) => {
    ...
    __name2(assembleStyles, "assembleStyles");
...
var require_util = __commonJS({
  "../../node_modules/.pnpm/chalk@4.1.2/node_modules/chalk/source/util.js"(exports, module2) {
    "use strict";
    var stringReplaceAll = /* @__PURE__ */ __name2((string, substring, replacer) => {
    ...
    var stringEncaseCRLFWithFirstIndex = /* @__PURE__ */ __name2((string, prefix, postfix, index) => {
      let endIndex = 0;
      let returnValue = "";
      do {
...
var require_templates = __commonJS({
  "../../node_modules/.pnpm/chalk@4.1.2/node_modules/chalk/source/templates.js"(exports, module2) {
    ...
    __name2(parseArguments, "parseArguments");
...
var require_source = __commonJS({
  "../../node_modules/.pnpm/chalk@4.1.2/node_modules/chalk/source/index.js"(exports, module2) {
    ...
    var applyOptions = /* @__PURE__ */ __name2((object, options = {}) => {
    ...
    __name2(ChalkClass, "ChalkClass");
    var chalkFactory = /* @__PURE__ */ __name2((options) => {
      const chalk2 = {};
    ...
    var createStyler = /* @__PURE__ */ __name2((open, close, parent) => {
      let openAll;
      let closeAll;
      if (parent === void 0) {
        openAll = open;
    ...
    var createBuilder = /* @__PURE__ */ __name2((self, _styler, _isEmpty) => {
      const builder = /* @__PURE__ */ __name2((...arguments_) => {
    ...
    var applyStyle = /* @__PURE__ */ __name2((self, string) => {
    ...
    var template;
    var chalkTag = /* @__PURE__ */ __name2((chalk2, ...strings) => {
...
var require_is_fullwidth_code_point = __commonJS({
  "../../node_modules/.pnpm/is-fullwidth-code-point@3.0.0/node_modules/is-fullwidth-code-point/index.js"(exports, module2) {
    "use strict";
    var isFullwidthCodePoint = /* @__PURE__ */ __name2((codePoint) => {
...
var require_astral_regex = __commonJS({
  "../../node_modules/.pnpm/astral-regex@2.0.0/node_modules/astral-regex/index.js"(exports, module2) {
    "use strict";
    var regex = "[\uD800-\uDBFF][\uDC00-\uDFFF]";
    var astralRegex = /* @__PURE__ */ __name2((options) => options && options.exact ? new RegExp(`^${regex}$`) : new RegExp(regex, "g"), "astralRegex");
...
var require_slice_ansi = __commonJS({
  "../../node_modules/.pnpm/slice-ansi@3.0.0/node_modules/slice-ansi/index.js"(exports, module2) {
    ...
    var wrapAnsi = /* @__PURE__ */ __name2((code) => `${ESCAPES[0]}[${code}m`, "wrapAnsi");
    var checkAnsi = /* @__PURE__ */ __name2((ansiCodes, isEscapes, endAnsiCode) => {
      let output = [];
      ansiCodes = [...ansiCodes];
...
var require_string_width = __commonJS({
  "../../node_modules/.pnpm/string-width@4.2.3/node_modules/string-width/index.js"(exports, module2) {
    ...
    var stringWidth = /* @__PURE__ */ __name2((string) => {
...
var require_cli_truncate = __commonJS({
  "../../node_modules/.pnpm/cli-truncate@2.1.0/node_modules/cli-truncate/index.js"(exports, module2) {
    ...
    __name2(getIndexOfNearestSpace, "getIndexOfNearestSpace");
...
var require_drawBox = __commonJS({
  "../sdk/dist/drawBox.js"(exports) {
    ...
    var __markAsModule2 = /* @__PURE__ */ __name2((target) => __defProp22(target, "__esModule", { value: true }), "__markAsModule");
    ...
    var __reExport = /* @__PURE__ */ __name2((target, module2, desc) => {
      if (module2 && typeof module2 === "object" || typeof module2 === "function") {
        for (let key of __getOwnPropNames(module2))
          if (!__hasOwnProp.call(target, key) && key !== "default")
            __defProp22(target, key, { get: () => module2[key], enumerable: !(desc = __getOwnPropDesc(module2, key)) || desc.enumerable });
      }
      return target;
    }, "__reExport");
    var __toModule = /* @__PURE__ */ __name2((module2) => {
      return __reExport(__markAsModule2(__defProp22(module2 != null ? __create(__getProtoOf(module2)) : {}, "default", module2 && module2.__esModule && "default" in module2 ? { get: () => module2.default, enumerable: true } : { value: module2, enumerable: true })), module2);
    }, "__toModule");
    __export2(exports, {
      drawBox: () => drawBox2
    });
    var import_chalk = __toModule(require_source());
    var import_cli_truncate = __toModule(require_cli_truncate());
    var import_string_width = __toModule(require_string_width());
    ...
    __name2(maxLineLength, "maxLineLength");
    __name22(maxLineLength, "maxLineLength");
    __name222(maxLineLength, "maxLineLength");
    function drawBox2({ title, width, height, str, horizontalPadding }) {
    ...
    __name(drawBox2, "drawBox2");
    __name2(drawBox2, "drawBox");
    __name22(drawBox2, "drawBox");
    __name222(drawBox2, "drawBox");
  }
});
...
var { drawBox } = require_drawBox();
var isInstalledGlobally = require_is_installed_globally();
var BOLD = "[1m";
var WHITE_BRIGHT = "[37;1m";
var RESET = "[0m";
function isPackageInstalledGlobally(name) {
  try {
    const pkgPath = __require.resolve(path.join(globalDirs.yarn.packages, `${name}/package.json`));
    return { pkgManager: "yarn", pkgPath };
  } catch (_) {
    try {
      const pkgPath = __require.resolve(path.join(globalDirs.npm.packages, `${name}/package.json`));
...
__name2(isPackageInstalledGlobally, "isPackageInstalledGlobally");
...
__name2(prismaIsInstalledGlobally, "prismaIsInstalledGlobally");
var b = /* @__PURE__ */ __name2((str) => BOLD + str + RESET, "b");
var white = /* @__PURE__ */ __name2((str) => WHITE_BRIGHT + str + RESET, "white");
function main() {
  ...
  const pkg = __require(installedGlobally.pkgPath);
